  ...
  <div class="microenv">
    <el-form inline :model="formSearch" label-width="70px" ref="primaryForm" style="float:left">
      <el-form-item label="环境名称">
        <el-input class="input_width_lg" placeholder="请选择环境" v-model="formSearch.queryEnvName" />
      </el-form-item>
      <el-form-item label="微服务名称">
        <el-input
          class="input_width_lg"
          placeholder="请选择微服务名称"
          v-model="formSearch.queryMicroEnvName"
        />
      </el-form-item>
        ...
        >
          <el-row>
            <el-form-item label="环境名称" prop="EnvName">
              <el-select
                class="input_width_lg"
                multiple
                v-model="MircroEnvForm.EnvName"
                placeholder="请选择环境名称"
                @change="rolesChanged"
              >
                <el-option
                  v-for="item in EnvNameList"
                  :label="item.EnvName"
                  :value="item.id"
                  :key="item.id"
                ></el-option>
          ...
          <el-row>
            <el-form-item label="微服务名称" prop="MicroServiceName">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.MicroServiceName"
                auto-complete="off"
                placeholder="请输入环境名称"
              />
            </el-form-item>
          ...
          <el-row>
            <el-form-item label="微服务登录用户名称" prop="loginuser">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.loginuser"
                auto-complete="off"
          ...
          <el-row>
            <el-form-item label="微服务登录用户密码" prop="loginpassword">
              <el-input
                type="password"
                class="input_width_lg"
                v-model="MircroEnvForm.loginpassword"
                auto-complete="off"
          ...
          <el-row>
            <el-form-item label="采集日志名称匹配规则" prop="lognamepattern">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.lognamepattern"
                auto-complete="off"
          ...
          <el-row>
            <el-form-item label="采集日志起始行正则匹配方式" prop="logpattern">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.logpattern"
                auto-complete="off"
          ...
          <el-row>
            <el-form-item label="日志后缀名称" prop="lognamepostfix">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.lognamepostfix"
                auto-complete="off"
          ...
          <el-row>
            <el-form-item label="间隔符号" prop="splitstr">
              <el-input
                class="input_width_lg"
                v-model="MircroEnvForm.splitstr"
                auto-complete="off"
