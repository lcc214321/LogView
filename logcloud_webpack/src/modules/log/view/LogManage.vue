<template>
  <div class="log">
    ...
    <div class="logtable">
      <el-table :data="loglist" style="width: 100%" :row-style="tableRowClassName">
        ...
        <el-table-column label="操作(大于10MB无法直接查看)">
...
<script>
import { BASIC_API, LOG_API } from "../../../../constants/constants.js";
export default {
  data() {
    return {
      formSearch: {
  ...
  methods: {
    ...
    handlecollect() {
      var param = new URLSearchParams(this.formSearch);
      var url = LOG_API + "/log/collect" + "?" + param;
