  ...
  <div class="log">
    <el-form inline :model="formSearch" label-width="90px" ref="primaryForm" style="float:left">
      ...
      <el-form-item label="采集日期">
        <el-date-picker v-model="formSearch.querydate" type="date" placeholder="选择日期" format="yyyy-MM-dd"
    ...
    <div class="logtable">
      <el-table :data="loglist" style="width: 100%" :row-class-name="tableRowClassName">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-tooltip :disabled="scope.row.canView" content="大于10MB无法进行浏览" placement="bottom" effect="dark">
               <el-button size="mini" :disabled="!scope.row.canView" @click="handleView(scope.$index, scope.row)">查看
              </el-button> 
            </el-tooltip>       
    ...
    methods: {
      ...
      handleDownload(index, row) {
        window.location.href =
          "http://localhost:8081" + LOG_API + "/log/downloadviewlog/" + row.id;
      },
